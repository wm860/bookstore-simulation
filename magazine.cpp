...
Magazine::Magazine(std::string author, std::string title, uint isbn, std::string genre, double price, std::string state, uint month, std::string year) : Book(author, title, isbn, genre, price, state), month(month), year(year) {}
